...
🧩 API GitHub: https://github.com/DenellVandayar/StudyNestApi.git
...
Sync the Gradle files by clicking the "Sync Now" button that appears in the top bar.
...
The only assistance used was Google Gemini Code Assist and ChatGPT, strictly for:
